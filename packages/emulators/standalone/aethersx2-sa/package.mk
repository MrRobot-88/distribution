...
makeinstall_target() {
  ...
  cp ${PKG_BUILD}/${PKG_NAME}-${PKG_VERSION}.AppImage ${INSTALL}/userdata/ps2/${PKG_NAME}
  cp -rf ${PKG_DIR}/scripts/start_aethersx2.sh ${INSTALL}/userdata/ps2/start_aethersx2.sh
  sed -e "s/@APPIMAGE@/${PKG_NAME}/g" -i ${INSTALL}/userdata/ps2/start_aethersx2.sh
